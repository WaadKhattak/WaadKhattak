# Hi, I'm Waad Khattak 👋 
### Aspiring Cybersecurity Engineer | Computer Science Student
...
* 🎓 **BS in Computer Science** — Developing foundational expertise in data structures, algorithms, and secure system architectures.

## 🛠️ Technical Skillset
* **Languages & Automation:** Python (Security Scripting, Log Analysis, Scapy), C++, Bash
...
### 📁 Security Scripting & Network Monitoring
* **[Custom Network Sniffer & Keylogger Framework]** - Built with Python and Scapy to intercept, parse, and evaluate real-time transport layer signatures and host-based interaction vectors.

### 📁 Data-Driven Threat Detection
* **[Credit Card Fraud Detection Architecture]** - Implemented machine learning frameworks in Python (`scikit-learn`, `pandas`) using SMOTE for class balancing and Random Forest to mitigate financial risk signatures.
